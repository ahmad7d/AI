...
def independent_pair(a1, a2):
    ...
    for add_effect in a1.get_add():
        if a2.is_neg_effect(add_effect):
            return False
    for add_effect in a2.get_add():
        if a1.is_neg_effect(add_effect):
            return False

    # Check for interference
    for precond in a1.get_pre():
        if a2.is_neg_effect(precond):
            return False
    for precond in a2.get_pre():
        if a1.is_neg_effect(precond):
            return False
